...
TEAMS_LIST_STRING = "HPK, HIFK, ILVES, JOKERIT, JUKURIT, JYP, KALPA, KESPOO, KOOKOO, KARPAT, LUKKO, PELICANS, SAIPA, SPORT, TAPPARA, TPS, ASSAT"
TEAMS_LIST = ["HPK", "HIFK", "ILVES", "JOKERIT", "JUKURIT", "JYP", "KALPA", "KESPOO", "KOOKOO", "KARPAT", "LUKKO", "PELICANS", "SAIPA", "SPORT", "TAPPARA", "TPS", "ASSAT"]
